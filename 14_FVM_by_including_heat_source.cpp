...
void solveTridiagonal(double K_A_deltaX, double q_a_deltaX, double T_A, double T_B, double T[]) {
    ...
    d[0] = 2 * K_A_deltaX * T_A + q_a_deltaX; // Right-hand side
...
int main() {
    ...
    cin >> T_B;
    cout << "Enter the value of heat source q: ";
    cin >> q;
    ...
    double  q_a_deltaX = q*A*deltaX;
    cout << "The value of q_a_deltaX is: " << q_a_deltaX << "\n";
    // Solve the tridiagonal system to find T1, T2, T3, T4
    solveTridiagonal(K_A_deltaX, q_a_deltaX, T_A, T_B, T);
